        ...
        script {
          try {
            sshagent(credentials: ['ssh-credential']) {
              sh """
              scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/${env.JOB_NAME}/target/${env.JOB_NAME}.jar ec2-user@3.38.221.36:/home/ec2-user/workspace/${env.JOB_NAME}.jar
